                    ...
                    <form noValidate onSubmit={this.handleSubmit}>
                        ...
                        <Grid container spacing={2} justify="center">
                            <Grid item xs={12} sm={6} >
                                <Button fullWidth type="submit" variant="contained" size="large" color="primary" id="signin">
                                    Sign In
                                </Button>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <Button fullWidth variant="outlined" onClick={this.registerNewUser} size="large" id="register" color="primary">
                                    Register
                                </Button>
                            </Grid>
                        </Grid>
